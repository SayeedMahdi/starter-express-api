...
router.group([authenticate(Admin), authorize], (router) => {
  ...
  router.group("/admin-users", (router) => {
    ...
    router.put(
      "/change-theme",
      adminValidation.changeTheme,
      AdminController.changeTheme
    );
    router.put(
      "/:id/change-password",
    ...
    router.group("/trash", (router) => {
      router.get("/", AdminController.getTrash, advancedResults);
      router.post("/restore/:id", AdminController.restoreAdmin);
      router.delete(
        "delete/:id/permanent",
        AdminController.permanentDeleteAdmin
      );
    });
  });
  ...
  router.group("/blog", (router) => {
    ...
    router.group("/trash", (router) => {
      router.get("/", BlogController.getTrash, advancedResults);
      router.post("/restore/:id", BlogController.restoreBlog);
      router.delete("delete/:id/permanent", BlogController.permanentDeleteBlog);
    });
  ...
  router.group("/faq", (router) => {
    router.get("/", FAQController.getFAQs, advancedResults);
  ...
  router.group("/media", (router) => {
    router.get("/", MediaController.getMedia, advancedResults);
    ...
    router.post(
      ...
      // imgUploader("image"),
      // uploadToCloudinary,
      mediaValidation.createAndUpdate,
